...
import (
	...
	"github.com/tsfnetwork/go-transaction_service_fee/cmd/utils"
	"github.com/tsfnetwork/go-transaction_service_fee/common"
	"github.com/tsfnetwork/go-transaction_service_fee/console"
	"github.com/tsfnetwork/go-transaction_service_fee/contracts/ens"
	"github.com/tsfnetwork/go-transaction_service_fee/crypto"
	"github.com/tsfnetwork/go-transaction_service_fee/ethclient"
	"github.com/tsfnetwork/go-transaction_service_fee/internal/debug"
	...
	"github.com/tsfnetwork/go-transaction_service_fee/swarm"
	bzzapi "github.com/tsfnetwork/go-transaction_service_fee/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the Transaction_service_fee API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the Transaction_service_fee API provider to use for ENS record lookups",
...
var app = utils.NewApp(gitCommit, "Transaction_service_fee Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-ethereum / go-transaction_service_fee Authors"
