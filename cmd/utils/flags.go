...
import (
	...
	"github.com/tsfnetwork/go-transaction_service_fee/accounts"
	"github.com/tsfnetwork/go-transaction_service_fee/accounts/keystore"
	"github.com/tsfnetwork/go-transaction_service_fee/common"
	"github.com/tsfnetwork/go-transaction_service_fee/consensus"
	"github.com/tsfnetwork/go-transaction_service_fee/consensus/clique"
	"github.com/tsfnetwork/go-transaction_service_fee/consensus/ethash"
	"github.com/tsfnetwork/go-transaction_service_fee/core"
	"github.com/tsfnetwork/go-transaction_service_fee/core/state"
	"github.com/tsfnetwork/go-transaction_service_fee/core/vm"
	"github.com/tsfnetwork/go-transaction_service_fee/crypto"
	"github.com/tsfnetwork/go-transaction_service_fee/eth"
	"github.com/tsfnetwork/go-transaction_service_fee/eth/downloader"
	"github.com/tsfnetwork/go-transaction_service_fee/eth/gasprice"
	"github.com/tsfnetwork/go-transaction_service_fee/ethdb"
	"github.com/tsfnetwork/go-transaction_service_fee/ethstats"
	"github.com/tsfnetwork/go-transaction_service_fee/les"
	"github.com/tsfnetwork/go-transaction_service_fee/log"
	"github.com/tsfnetwork/go-transaction_service_fee/metrics"
	"github.com/tsfnetwork/go-transaction_service_fee/node"
	"github.com/tsfnetwork/go-transaction_service_fee/p2p"
	"github.com/tsfnetwork/go-transaction_service_fee/p2p/discover"
	"github.com/tsfnetwork/go-transaction_service_fee/p2p/discv5"
	"github.com/tsfnetwork/go-transaction_service_fee/p2p/nat"
	"github.com/tsfnetwork/go-transaction_service_fee/p2p/netutil"
	"github.com/tsfnetwork/go-transaction_service_fee/params"
	whisper "github.com/tsfnetwork/go-transaction_service_fee/whisper/whisperv5"
...
func RegisterEthService(stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the Transaction_service_fee service: %v", err)
	}
}
...
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		...
		Fatalf("Failed to register the Transaction_service_fee Stats service: %v", err)
	}
}
