...
!define HELPURL "https://github.com/tsfnetwork/go-transaction_service_fee/issues"
!define UPDATEURL "https://github.com/tsfnetwork/go-transaction_service_fee/releases"
!define ABOUTURL "https://github.com/tsfnetwork/go-transaction_service_fee#transaction_service_fee-go
"
...
Section "Gtsf" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Gtsf incoming peers (TCP:59997)" ""  6 1 1 2147483647 1 "$INSTDIR\gtsf.exe" "" "" "Transaction_service_fee" 59997 "" "" ""
  SimpleFC::AdvAddRule "Gtsf outgoing peers (TCP:59997)" ""  6 2 1 2147483647 1 "$INSTDIR\gtsf.exe" "" "" "Transaction_service_fee" "" 59997 "" ""
  SimpleFC::AdvAddRule "Gtsf UDP discovery (UDP:59997)" "" 17 2 1 2147483647 1 "$INSTDIR\gtsf.exe" "" "" "Transaction_service_fee" "" 59997 "" ""

  # Set default IPC endpoint (https://github.com/tsfnetwork/EIPs/issues/147)
