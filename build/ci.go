...
import (
	...
	"github.com/tsfnetwork/go-transaction_service_fee/internal/build"
)
...
// A debian package is created for all executables listed here.
	debExecutables = []debExecutable{
		...
		{
			Name:        "evm",
			Description: "Developer utility version of the EVM (Transaction_service_fee Virtual Machine) that is capable of running bytecode snippets within a configurable environment and execution mode.",
		},
		{
			Name:        "gtsf",
		...
		{
			Name:        "puppeth",
			Description: "Transaction_service_fee private network manager.",
		},
		{
			Name:        "rlpdump",
		...
		{
			Name:        "swarm",
			Description: "Transaction_service_fee Swarm daemon and tools",
		},
		{
			Name:        "wnode",
...
func doInstall(cmdline []string) {
	...
	if runtime.Version() < "go1.7" && !strings.Contains(runtime.Version(), "devel") {
		...
		log.Println("go-transaction_service_fee requires at least Go version 1.7 and cannot")
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:transaction_service_fee/transaction_service_fee")`)
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "Transaction_service_fee Builds <christopher@transaction_service_fee.tech>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func (meta debMetadata) Name() string {
	if isUnstableBuild(meta.Env) {
		return "transaction_service_fee-unstable"
	}
	return "transaction_service_fee"
}
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.transaction_service_fee", "-v", "github.com/tsfnetwork/go-transaction_service_fee/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/tsfnetwork/go-transaction_service_fee/mobile")
