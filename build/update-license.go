...
var (
	...
	authorsFileHeader = "# This is the official list of go-ethereum / go-transaction_service_fee authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ethereum / go-transaction_service_fee Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-transaction_service_fee"
	}
	if startOfSentence {
		return "The go-transaction_service_fee library"
	}
	return "the go-transaction_service_fee library"
}
