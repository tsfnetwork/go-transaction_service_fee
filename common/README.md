...
[![Build
Status](https://travis-ci.org/tsfnetwork/go-transaction_service_fee.png?branch=master)](https://travis-ci.org/tsfnetwork/go-transaction_service_fee)
...
RLP Encoding is an encoding scheme used by the Transaction_service_fee project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.transaction_service_fee.tech/index.php/RLP) article.
...
found on the [Wiki](http://wiki.transaction_service_fee.tech/index.php/Patricia_Tree).
