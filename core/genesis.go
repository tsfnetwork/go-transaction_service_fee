...
//go:generate gencodec -type Genesis -field-override genesisSpecMarshaling -out gengenesis.go
//go:generate gencodec -type GenesisAccount -field-override genesisAccountMarshaling -out gengenesisaccount.go
