...
import (
	...
	"github.com/tsfnetwork/go-transaction_service_fee/logger"
	"github.com/tsfnetwork/go-transaction_service_fee/p2p"
	"github.com/tsfnetwork/go-transaction_service_fee/p2p/nat"
	"github.com/tsfnetwork/go-transaction_service_fee/whisper"
)
...
func main() {
	...
	fmt.Println("Starting Transaction_service_fee peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Transaction_service_fee peer: %v.\n", err)
		os.Exit(1)
	}
