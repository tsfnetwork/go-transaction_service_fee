...
func signHash(data []byte) []byte {
	msg := fmt.Sprintf("\x19Transaction_service_fee Signed Message:\n%d%s", len(data), data)
...
//
// https://github.com/tsfnetwork/go-transaction_service_fee/wiki/Management-APIs#personal_sign
...
//
// https://github.com/tsfnetwork/go-transaction_service_fee/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != 65 {
		return common.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid Transaction_service_fee signature (V is not 27 or 28)")
	}
